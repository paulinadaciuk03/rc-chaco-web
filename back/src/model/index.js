...
const ComentariosNoticias = require("./comentarios_noticias")(
  sequelize,
  DataTypes
);
...
const PublicacionImagenes = require("./PublicacionImagen")(
  sequelize,
  DataTypes
);
const ComentariosPublicaciones = require("./ComentarioPublicacion")(
  sequelize,
  DataTypes
);
